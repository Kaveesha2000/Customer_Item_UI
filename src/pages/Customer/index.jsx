...
import CustomButton from '../../compenents/common/Button/index';
                ...
                <ValidatorForm ref="form" className="pt-2" onSubmit={this.submitCustomer} >
                    <Grid container className="pt-2" spacing={3}>
                        <Grid item lg={12} xs={12} sm={12} md={12} style={{display:"flex",justifyContent:"center"}}>
                            <Typography style={{color:"#0c2461"}} variant="h3">Customer Manage</Typography>
                        </Grid>
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <Typography style={{marginLeft:'10px'}} variant="subtitle1">Customer Id</Typography>
                                <TextValidator
                                    id="outpointed"
                            ...
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <Typography variant="subtitle1" style={{marginLeft:'10px'}}>Customer Name</Typography>
                                <TextValidator
                                    id="outlinedbasic"
                            ...
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <Typography style={{marginLeft:'10px'}} variant="subtitle1">Customer Address</Typography>
                                <TextValidator
                                    id="outlinedbasic"
                            ...
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <Typography style={{marginLeft:'10px'}} variant="subtitle1">Customer Salary</Typography>
                                <TextValidator
                                    id="outlinedbasic"
